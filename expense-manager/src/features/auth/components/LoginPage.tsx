...
import { signInMobile, cancelMobileOAuth } from '../../../shared/services/mobileOAuth';
...
export function LoginPage() {
  ...
  // Cancel any in-flight mobile OAuth if the user leaves the login page.
  useEffect(() => {
    return () => { if (isNative) cancelMobileOAuth(); };
  }, [isNative]);
